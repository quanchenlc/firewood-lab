...
Cut-face (inner) maps use a **bark-edge atlas** composited by `scripts/barkedge-atlas.py`: thin bark strips L/R (~3% each, ref-like) + longitudinal split grain in the middle (screen.toys *approach*, **not** their assets — do **not** download `insidegrain.jpg`).
